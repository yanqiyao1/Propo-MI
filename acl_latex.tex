...
\begin{figure*}[t]
  ...
  \begin{subfigure}[b]{0.31\textwidth}
    \centering
    \includegraphics[width=\linewidth]{./reports/mlp_analysis/mlp_8b_one_hop/facts_region/mlp_facts_region_scores.png}
    \caption{Facts Region}
    \label{fig:stage_facts}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.31\textwidth}
    \centering
    \includegraphics[width=\linewidth]{./reports/mlp_analysis/mlp_8b_one_hop/expression_region/mlp_expression_region_scores.png}
    \caption{Expression Region}
    \label{fig:stage_expression}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.31\textwidth}
    \centering
    \includegraphics[width=\linewidth]{./reports/mlp_analysis/mlp_8b_one_hop/query_region/mlp_query_region_scores.png}
    \caption{Query Region}
    \label{fig:stage_query}
  \end{subfigure}
  
  \caption{Region-wise MLP mean-ablation scores in \textit{Qwen3-8B} on one-hop \texttt{facts\_first} prompts, rendered directly from the saved analysis outputs in \path{reports/mlp_analysis/mlp_8b_one_hop}. The three current semantic regions are \textbf{Facts Region}, \textbf{Expression Region}, and \textbf{Query Region}, where the Query Region contains the query anchor together with the answer-suffix tail used by the prompt formatter. The model exhibits a staged sensitivity profile: facts are most important in early layers, expressions peak in the middle of the network, and the query region becomes increasingly important in middle and late layers, consistent with final answer aggregation. Additional model-scale, prompt-order, and region-variant comparisons are shown in Appendix~\ref{sec:appendix_stage}, Appendix~\ref{sec:appendix_region_variants}, and Appendix~\ref{sec:appendix_prompt_order}.}
  \label{fig:stage}
  \vspace{-0.5em}
\end{figure*}
% 说明文，总分的方式（较为清晰）。
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis/comparison/band_metrics_panel.png}
        \caption{MLP}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_analysis/comparison/band_metrics_panel.png}
        \caption{Attention}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_mlp_analysis/comparison/band_metrics_panel.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{./reports/heads_analysis_qwen3_8b_facts_first/taxonomy/head_taxonomy_line_chart.png}
    \caption{Layer-wise distribution of the three head roles in the saved \textit{Qwen3-8B} \texttt{facts\_first} taxonomy results, rendered from \path{reports/heads_analysis_qwen3_8b_facts_first/taxonomy/head_taxonomy_line_chart.png}. Splitting Heads concentrate in early layers, Transmission Heads span the middle of the network, and Fact-Retrieval Heads peak in middle-to-late layers. Appendix~\ref{appendix_heads} extends this analysis to both model scales and both prompt orders, and further shows that ablating the selected heads causes large accuracy drops while random controls do not.}
\label{fig:counts}
\vspace{-0.5em}
\end{figure}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis/mlp_14b_one_hop/facts_region/mlp_facts_region_scores.png}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis/mlp_14b_one_hop/expression_region/mlp_expression_region_scores.png}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis/mlp_14b_one_hop/query_region/mlp_query_region_scores.png}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis/mlp_14b_two_hop/facts_region/mlp_facts_region_scores.png}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis/mlp_14b_two_hop/expression_region/mlp_expression_region_scores.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis_expr_first/comparison_expr_first/band_metrics_panel.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis_expr_first/comparison_expr_first_14B/band_metrics_panel.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.24\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis_expr_first/mlp_8b_one_hop_expr_first/query_region/mlp_query_region_scores.png}
    ...
    \begin{subfigure}[b]{0.24\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/mlp_analysis_expr_first/mlp_14b_one_hop_expr_first/query_region/mlp_query_region_scores.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/heads_analysis_qwen3_8b_expr_first/taxonomy/head_taxonomy_line_chart.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/heads_analysis_qwen3_14b_expr_first/taxonomy/head_taxonomy_line_chart.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/heads_analysis_qwen3_8b_expr_first/validation/plots/pd_abs_ratio_curve.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/heads_analysis_qwen3_14b_expr_first/validation/plots/pd_abs_ratio_curve.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_analysis/attn_8b_one_hop/facts_region/attn_facts_region_scores.png}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_analysis/attn_8b_one_hop/expression_region/attn_expression_region_scores.png}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_analysis/attn_8b_one_hop/query_region/attn_query_region_scores.png}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_analysis/attn_14b_one_hop/facts_region/attn_facts_region_scores.png}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_analysis/attn_14b_one_hop/expression_region/attn_expression_region_scores.png}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_analysis/attn_14b_one_hop/query_region/attn_query_region_scores.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_mlp_analysis/attn_mlp_8b_one_hop/facts_region/attn_mlp_facts_region_scores.png}
        \caption{\textit{Qwen3-8B}: Facts}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_mlp_analysis/attn_mlp_8b_one_hop/expression_region/attn_mlp_expression_region_scores.png}
        \caption{\textit{Qwen3-8B}: Expression}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_mlp_analysis/attn_mlp_8b_one_hop/query_region/attn_mlp_query_region_scores.png}
        \caption{\textit{Qwen3-8B}: Query}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_mlp_analysis/attn_mlp_14b_one_hop/facts_region/attn_mlp_facts_region_scores.png}
        \caption{\textit{Qwen3-14B}: Facts}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_mlp_analysis/attn_mlp_14b_one_hop/expression_region/attn_mlp_expression_region_scores.png}
        \caption{\textit{Qwen3-14B}: Expression}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/attn_mlp_analysis/attn_mlp_14b_one_hop/query_region/attn_mlp_query_region_scores.png}
        \caption{\textit{Qwen3-14B}: Query}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/heads_analysis_qwen3_14b_facts_first/taxonomy/head_taxonomy_line_chart.png}
...
\caption{Layer-wise distribution of functional attention heads in \textit{Qwen3-14B}, rendered from the saved taxonomy plots in \\path{reports/heads_analysis_qwen3_14b_facts_first/taxonomy/head_taxonomy_line_chart.png} and \\path{reports/heads_analysis_qwen3_14b_expr_first/taxonomy/head_taxonomy_line_chart.png}. Panel (a) shows the default \texttt{facts\_first} setting, while panel (b) shows the prompt-order intervention \texttt{expr\_first}. In both cases, Splitting Heads concentrate in early layers, Transmission Heads span the middle of the network, and Fact-Retrieval Heads peak in middle-to-late layers. The main prompt-order effect is quantitative rather than qualitative: \texttt{expr\_first} increases the abundance of Splitting Heads while preserving the same coarse layer-wise topology.}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/token_analysis/8b_facts_first_all_hop_refined/refined_by_stage_sum.png}
        \caption{\textit{Qwen3-8B}, \texttt{facts\_first}}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/token_analysis/14b_facts_first_all_hop_refined/refined_by_stage_sum.png}
        \caption{\textit{Qwen3-14B}, \texttt{facts\_first}}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/token_analysis_facts_first_refined/refined_by_stage_sum.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_mistral/token_analysis_facts_first_refined/refined_by_stage_sum.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/mlp_analysis_expr_first/comparison/band_metrics_panel.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/attn_analysis_facts_first/comparison/band_metrics_panel.png}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/attn_mlp_analysis_facts_first/comparison/band_metrics_panel.png}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/attn_analysis_expr_first/comparison/band_metrics_panel.png}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/attn_mlp_analysis_expr_first/comparison/band_metrics_panel.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/heads_analysis_facts_first/taxonomy/head_taxonomy_line_chart.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/heads_analysis_expr_first/taxonomy/head_taxonomy_line_chart.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/heads_analysis_facts_first/validation/plots/pd_abs_ratio_curve.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/heads_analysis_expr_first/validation/plots/pd_abs_ratio_curve.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/token_analysis/8b_expr_first_all_hop_refined/refined_by_stage_sum.png}
        \caption{\textit{Qwen3-8B}, \texttt{expr\_first}}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports/token_analysis/14b_expr_first_all_hop_refined/refined_by_stage_sum.png}
        \caption{\textit{Qwen3-14B}, \texttt{expr\_first}}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_llama3/token_analysis_expr_first_refined/refined_by_stage_sum.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_mistral/token_analysis_expr_first_refined/refined_by_stage_sum.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_mistral/mlp_analysis_facts_first/comparison/band_metrics_panel.png}
        \caption{\texttt{facts\_first}}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_mistral/mlp_analysis_expr_first/comparison/band_metrics_panel.png}
        \caption{\texttt{expr\_first}}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_mistral/attn_analysis_facts_first/comparison/band_metrics_panel.png}
        \caption{\texttt{facts\_first}: Attention}
        \label{fig:mistral_band_ff_attn}
    \end{subfigure}
    \caption{\textbf{Mistral-7B-Instruct-v0.1: available band-level region summaries.} The current artifact snapshot provides MLP summaries for both prompt orders and an attention summary for \texttt{facts\_first}. These plots reinforce the same broad staged pattern seen in the region triples, while also showing that Mistral places comparatively strong mass on late Query behavior. The remaining Mistral band summaries are not yet part of the committed output snapshot.}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_mistral/heads_analysis_facts_first/taxonomy/head_taxonomy_line_chart.png}
        \caption{\texttt{facts\_first}: role distribution}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_mistral/heads_analysis_expr_first/taxonomy/head_taxonomy_line_chart.png}
        \caption{\texttt{expr\_first}: role distribution}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_mistral/heads_analysis_facts_first/validation/plots/pd_abs_ratio_curve.png}
        \caption{\texttt{facts\_first}: validation curve}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{./reports_mistral/heads_analysis_expr_first/validation/plots/pd_abs_ratio_curve.png}
        \caption{\texttt{expr\_first}: validation curve}
