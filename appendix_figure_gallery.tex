...
\makeatletter
% This gallery is included after \onecolumn, so a regular figure already spans
% the full page width. Routing figure* through the normal float queue avoids
% exhausting the double-float queue under XeLaTeX.
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.78\columnwidth]{./figures_experiments/reports_mistral/attn_mlp_analysis_facts_first/comparison/band_metrics_panel.png}
