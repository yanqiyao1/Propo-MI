...
plot_region_scores_for_hop_dir() {
  ...
  for region in facts_region expression_region query_region; do
    python -m src.mlp_analysis.plot_region_scores \
      --scores_csv "${hop_dir}/${region}/mlp_${region}_scores.csv" \
      --output_png "${hop_dir}/${region}/mlp_${region}_scores.png"
  done
}
...
plot_experiment \
  "reports/mlp_analysis/mlp_14b_one_hop" \
  "reports/mlp_analysis/mlp_14b_two_hop" \
  "reports/mlp_analysis/comparison_14B"
...
plot_experiment \
  "reports/mlp_analysis_expr_first/mlp_14b_one_hop_expr_first" \
  "reports/mlp_analysis_expr_first/mlp_14b_two_hop_expr_first" \
  "reports/mlp_analysis_expr_first/comparison_expr_first_14B"
...
plot_experiment \
  "reports/mlp_analysis/mlp_8b_one_hop" \
  "reports/mlp_analysis/mlp_8b_two_hop" \
  "reports/mlp_analysis/comparison"
...
plot_experiment \
  "reports/mlp_analysis_expr_first/mlp_8b_one_hop_expr_first" \
  "reports/mlp_analysis_expr_first/mlp_8b_two_hop_expr_first" \
  "reports/mlp_analysis_expr_first/comparison_expr_first"
